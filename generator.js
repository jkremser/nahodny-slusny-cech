...
var other = ['Prece  nam nebudou rikat jestli mame mit pravo saria , pivo a klobasku bych jim povine dal vsem snizt. ',
  ...
  'rupubliku si  rozvracen nenechame ',
  ...
  'Stejne tak jako USA  nebyly nikdy na mesyci ,tak media mlci o te velke pravde o imigrantech , je to vsechno' +
  ' naplanovane kvuli new world order.Otevrete uz konecne oci, vy tupe ovce! !',
  'Jinak ja jsem hrdy na nase hodnoty, co si dokazal ty ty havlomrde jedem kurvo ?  ',
...
var badPplSentences = [
  ...
  [2, ' Vzdyt kdyz jsou tak mladi a maji na mobilni  telefon tak prece muzou i jit bojovat za svoji zemi to jenom {0} z {1} rikaji ,ze jich je tady jenom malo,ale to se zmeni.'],
  ...
  [3, 'Prece nechceme aby slusni lidi musely platit  jenom dane jak ovce a {0}, {1} a {2} porad jenom kradli tohle uz ne!!!  '],
  [1, 'Jinak vcera jsem se dival na oblohu a bila tam velka davka chemtrails vetsi nez obvikle muzou za to {1} a Kalousek!!!!!!']
];

var goodPpl = ['pan Babis', 'Babis', 'pan mluvci Ovcacek', 'Zeman', 'pan prezident', 'Okamura',
   'pan prezident Putin', 'Putin', 'Ortel', 'prezident Trump', 'Fico', 'Adam B. Bartos'];
...
var badPpl = ['Sobotka', 'vlastizradce Sobotka', 'slunickari', 'prohavlovska pakaz', 'kolaboranti', 'muslimaci',
 ...
 'iluminati', 'USA ambasada', 'CIA', 'korporace', 'diktat z EU'];
...
function getPost(length, capslock) {
  // length 2 - 7
  length = length || Math.random() * 4 + 2;
  capslock = capslock || 0.3
